...
public:
	...
	GuiImage(struct XenosSurface * img, int w, int h);
	//!\overload
	//!Creates an image filled with the specified color
	//!\param w Image width
	//!\param h Image height
	//!\param c Image color
	GuiImage(int w, int h, XeColor c);
	//!Destructor
	~GuiImage();
	...
	void SetImage(struct XenosSurface * img, int w, int h);
	//!Gets the pixel color at the specified coordinates of the image
	//!\param x X coordinate
	//!\param y Y coordinate
	XeColor GetPixel(int x, int y);
	//!Sets the pixel color at the specified coordinates of the image
	//!\param x X coordinate
	//!\param y Y coordinate
	//!\param color Pixel color
	void SetPixel(int x, int y, XeColor color);
...
public:
	...
	void SetPresets(int sz, XeColor c, int w, u16 s, int h, int v);
	//!Sets the font size
	//!\param s Font size
...
public:
	...
	void SetSelectedFontColor(int color);
