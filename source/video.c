...
void Menu_Frame(){
    ...
    FrameTimer++;
	// reset all vb
	void * v = Xe_VB_Lock(g_pVideoDevice,vb,SHARED_VB_SIZE, MAX_VERTEX_COUNT * sizeof (DrawVerticeFormats) - SHARED_VB_SIZE,XE_LOCK_READ|XE_LOCK_WRITE);
	memset(v,0,MAX_VERTEX_COUNT * sizeof (DrawVerticeFormats) - SHARED_VB_SIZE);	
