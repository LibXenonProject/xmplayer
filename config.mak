...
prefix  = $(DESTDIR)/usr/local/xenon/usr
BINDIR  = $(DESTDIR)/usr/local/xenon/usr/bin
DATADIR = $(DESTDIR)/usr/local/xenon/usr/share/mplayer
LIBDIR  = $(DESTDIR)/usr/local/xenon/usr/lib
MANDIR  = $(DESTDIR)/usr/local/xenon/usr/share/man
CONFDIR = $(DESTDIR)/usr/local/xenon/usr/etc/mplayer
...
OPTIFLAGS = -Ofast -mcpu=cell -mtune=cell
CFLAGS   = $(OPTIFLAGS) -Wundef -Wall -Wno-switch -Wno-parentheses -Wpointer-arith -Wredundant-decls -Wstrict-prototypes -Wmissing-prototypes -Wdisabled-optimization -Wno-pointer-sign -Wdeclaration-after-statement -std=gnu99 -Werror-implicit-function-declaration -pipe -ffast-math -fomit-frame-pointer -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE64_SOURCE -I. -Iffmpeg -m32 -fno-pic -mpowerpc64 -I/usr/local/xenon/usr/include/ -I$(DEVKITXENON)/usr/include/freetype2 -Wall -Ilibxenon_miss -g
CXXFLAGS = $(OPTIFLAGS) -Wundef -Wall -Wno-switch -Wno-parentheses -Wpointer-arith -Wredundant-decls -pipe -ffast-math -fomit-frame-pointer -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE64_SOURCE -D__STDC_CONSTANT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_LIMIT_MACROS -I. -Iffmpeg -m32 -fno-pic -mpowerpc64 -I/usr/local/xenon/usr/include/ -I$(DEVKITXENON)/usr/include/freetype2 -Wall -Ilibxenon_miss 
CC_DEPFLAGS = -MD -MP
...
EXTRALIBS          =  -lxenon -lz -lbz2 -lfat -lfreetype -liconv -lfribidi $(OPTIFLAGS) -Wl,-z,noexecstack -lm -m32 -maltivec -fno-pic -mpowerpc64 -L/usr/local/xenon/usr/lib/ -L/usr/local/xenon/xenon/lib/32/ -T/usr/local/xenon/app.lds -u read -u _start -u exc_base -ffast-math  
EXTRALIBS_MPLAYER  = 
EXTRALIBS_MENCODER = 
